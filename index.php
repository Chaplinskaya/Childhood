...
?>
            ...
            <div class="glide__track" data-glide-el="track">
                ...
                <?php
                    ...
                    foreach( $my_posts as $post ){
                        ...
                        <li style="background-image: url('<?php the_field('image_slider'); ?>')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    ...
                                    <?php
                                        ...
                                        if ($field == 'on') {
                                            ?>
                                                <a href="<?php the_field('link_slider'); ?>" class="button">More information</a>
                                            <?php
                                        }
                                        ?>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <img src="<?php the_field('image_present') ?>" alt="про компанию">
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        foreach( $my_posts as $post ){
                            ...
                            <div class="toys__item-info">
                                ...
                                <div class="minibutton toys__trigger">More info</div>
                            </div>
                        </div>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title"> <?php the_field('where_title') ?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="<?php the_field('phone1', 2) ?>"><?php the_field('phone1', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Phone №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="<?php the_field('phone2', 2) ?>"><?php the_field('phone2', 2) ?></a>
                                    </div>
                                </div>
                            </div>
                 ...
                 <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="91d04e6" title="Feedback form"]'); ?>
                 </div>
                    </div>
                </div>
                <div class="row mt70">
                                ...
                                <ul class="glide__slides">
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                            <?php the_field('name_review1') ?>
                                        </div>
                                        <div class="feedslider__text">
                                             <?php the_field('text_review1') ?>
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                             <?php the_field('name_review2') ?>
                                        </div>
                                        <div class="feedslider__text">
                                           <?php the_field('text_review2') ?>
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                             <?php the_field('name_review3') ?>
                                        </div>
                                        <div class="feedslider__text">
                                            <?php the_field('text_review3') ?>
                                        </div>
                                    </li>
                                </ul>
                            </div>
